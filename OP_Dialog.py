...
class m_OP_Dialog ( wx.Frame ):
	
	def __init__( self, parent ):
		#wx.Frame.__init__ ( self, parent, id = wx.ID_ANY, title = u"観測点の指定", pos = wx.DefaultPosition, size = wx.Size( 413,447 ), style = wx.DEFAULT_FRAME_STYLE|wx.STAY_ON_TOP|wx.TAB_TRAVERSAL, name = u"観測点の指定" )
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"観測点の指定",  pos = wx.Point( 0,0 ), size = wx.Size( 413,447 ), style= wx.STAY_ON_TOP | wx.RESIZE_BORDER | wx.SYSTEM_MENU | wx.CAPTION | wx.CLIP_CHILDREN, name = u"観測点の指定" )
		...
		m_comboBox1Choices = [ u"点", u"線", u"矩形", u"マスクファイル", u"過去の観測点ファイル" ]
		self.m_comboBox1 = wx.ComboBox( sbSizer4.GetStaticBox(), wx.ID_ANY, u"点", wx.DefaultPosition, wx.DefaultSize, m_comboBox1Choices, wx.CB_DROPDOWN|wx.CB_READONLY )
		self.m_comboBox1.SetSelection( 0 )
		self.m_comboBox1.SetFont( wx.Font( 9, wx.FONTFAMILY_MODERN, wx.FONTSTYLE_NORMAL, wx.FONTWEIGHT_NORMAL, False, "ＭＳ Ｐゴシック" ) )
		self.m_comboBox1.SetForegroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_BACKGROUND ) )
		self.m_comboBox1.SetBackgroundColour( wx.SystemSettings.GetColour( wx.SYS_COLOUR_WINDOW ) )
		
		bSizer23.Add( self.m_comboBox1, 0, wx.ALL, 5 )
		...
		self.m_spinCtrl51 = wx.SpinCtrl( sbSizer4.GetStaticBox(), wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.Size( 70,-1 ), wx.SP_ARROW_KEYS, 1, 99, 5 )
		...
		self.m_textCtrl11 = wx.TextCtrl( sbSizer5.GetStaticBox(), wx.ID_ANY, u"1", wx.DefaultPosition, wx.Size( 120,-1 ), 0 )
		...
		self.m_button4 = wx.Button( self, wx.ID_ANY, u"リセット", wx.DefaultPosition, wx.DefaultSize, 0 )
